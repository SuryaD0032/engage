...
const { name,about,age,place,profession,interests,insp,availability,otheruser,languages,image } = route.params;
  ...
  return (
    ...
    <View style={{alignContent:'center',height:128,width:'100%',backgroundColor:'#0A0A67',marginBottom:'8%'}}>
     ...
     <Image source={require('../assets/icons/goback2.png')} style={styles.sicon} />
        ...
        <TextInput value={name} style={{fontSize:20,color:'#F5FEFD',fontFamily:'Montserrat-ExtraBold',backgroundColor:'#0A0A67',height:26,alignSelf:'center'}}></TextInput>
...
{toggleButton ? (
  ...
  top:'15.8587145676%',fontFamily:'Montserrat-ExtraBoldItalic'}}>FOLLOW</Text>
) : (
  <Text style={{fontSize:12,color:'white',
  alignSelf:'center',top:'15.8587145676%',fontFamily:'Montserrat-BoldItalic'}}>FOLLOWING</Text>
)}
</TouchableOpacity>
 </View>    
